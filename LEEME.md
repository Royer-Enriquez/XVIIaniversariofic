...
Extrae este ZIP en una carpeta nueva. Abre `FIC-2026-MAPS-CORREGIDO/index.html` de esta entrega.
...
2. Abre `FIC-2026-MAPS-CORREGIDO/index.html` para revisar la página. No la abras dentro del ZIP.
3. Sube el contenido de `FIC-2026-MAPS-CORREGIDO/` a la carpeta pública del alojamiento. `index.html` debe estar junto a los archivos CSS, JavaScript y la carpeta `assets/`.
...
- Se mantienen las 37 actividades, las 24 participaciones académicas, los 11 retratos y las cuatro fotografías del encuentro de 2024.
...
- Fotografías de las 12 personas cuyos retratos no se pudieron verificar. PMO Francia figura como entidad.
