...
Extrae este ZIP en una carpeta nueva. Abre `FIC-2026-FOTOS-ACTUALIZADAS/index.html` de esta entrega.
...
2. Abre `FIC-2026-FOTOS-ACTUALIZADAS/index.html` para revisar la página. No la abras dentro del ZIP.
3. Sube el contenido de `FIC-2026-FOTOS-ACTUALIZADAS/` a la carpeta pública del alojamiento. `index.html` debe estar junto a los archivos CSS, JavaScript y la carpeta `assets/`.
...
Se añadieron las fotos de Mikhail Dmitrusenko, Rodolfo Ribbeck Hurtado, Edwin Lovón Sánchez y Adolfo Lazo Hospinal. Las 15 tarjetas con fotografía se muestran al entrar a la sección Ponentes. El botón amplía la lista a los 24 participantes.
...
- Se mantienen las 37 actividades, las 24 participaciones académicas, los 15 retratos y las cuatro fotografías del encuentro de 2024.
...
- Fotografías de las ocho personas cuyos retratos no se pudieron verificar. PMO Francia figura como entidad.
