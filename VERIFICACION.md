...
- Se mantienen las 37 actividades del programa y sus datos, las 24 participaciones académicas, los 11 retratos y las cuatro fotos de 2024.
...
Se creó un ZIP y una carpeta nuevos: `FIC-2026-MAPS-CORREGIDO`. Se comprobó el HTML extraído de este paquete: cabecera «Google Maps», portada «Ver ubicación en Google Maps» y ausencia de controles de inscripción o enlaces a Google Forms. Los recursos locales incluyen un identificador de versión en sus URL.
