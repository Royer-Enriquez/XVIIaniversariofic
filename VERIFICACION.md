...
- Se mantienen las 37 actividades del programa y sus datos, las 24 participaciones académicas, los 15 retratos y las cuatro fotos de 2024.
...
Se creó un ZIP y una carpeta nuevos: `FIC-2026-FOTOS-ACTUALIZADAS`. Se comprobó el HTML extraído de este paquete: cabecera «Google Maps», portada «Ver ubicación en Google Maps» y ausencia de controles de inscripción o enlaces a Google Forms. Los recursos locales incluyen un identificador de versión en sus URL.

## Fotografías añadidas

Se revisaron visualmente los cuatro archivos nuevos y la leyenda de la publicación de origen cuando correspondía. Se conservan sus bytes originales; los ajustes de encuadre pertenecen al CSS. La sección muestra 15 fotografías inicialmente y 24 participantes al ampliar.
